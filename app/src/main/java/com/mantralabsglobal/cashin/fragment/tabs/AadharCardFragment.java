 ...
 */
public class AadharCardFragment extends Fragment {
    ...
    private View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            {
                child = currentView.findViewById(R.id.enterAadharDetailLayout);
            }
            else
            {
                child = currentView.findViewById(R.id.aadharCardSnapLayout);
            }
            if(child != null)
