...
public class CustomEditText extends LinearLayout {
    ...
    public CustomEditText(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        try {
            tv_label.setText(ta.getString(R.styleable.custom_edit_view_field_label));
           // iv_icon.setImageResource(R.drawable.ic_work_address);

            Drawable drawable = ta.getDrawable(R.styleable.custom_edit_view_field_icon);
            if (drawable != null)
                iv_icon.setBackground(drawable);
            et_editText.setText(ta.getString(R.styleable.custom_edit_view_field_text));
        } finally {
            ta.recycle();
        }
